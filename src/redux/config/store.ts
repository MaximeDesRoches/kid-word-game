import { configureStore, ThunkDispatch, ThunkMiddleware } from '@reduxjs/toolkit';
...
function filterActions(_getState: () => IRootState, action: AnyAction) {
...
export const store = configureStore({
	...
	middleware: (getDefaultMiddleware) => {
		...
		middleware.push(createLogger({ collapsed: true, predicate: filterActions }) as ThunkMiddleware<IRootState, AnyAction>);
