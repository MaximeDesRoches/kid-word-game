...
import { faArrowLeft, faArrowRotateLeft, faBullhorn, faEye, faEyeSlash } from '@fortawesome/free-solid-svg-icons';
			...
			{ currentWord && 
				<>
					<div className="card hint">
						<span style={{ opacity: showHint ? 1 : 0 }}>{currentWord.word}</span> <span className="icon"><FontAwesomeIcon icon={faBullhorn} onClick={onClickWord} /></span> <span className="icon"><FontAwesomeIcon icon={showHint ? faEyeSlash : faEye} onClick={onClickShowHint} /></span>
					</div>
